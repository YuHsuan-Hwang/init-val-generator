...
width = 256
height = 256
#image = GaussianImage(width, height, random_seed=8, n=1, plot_mode="all") # single gaussian
image = GaussianImage(width, height, random_seed = 0, plot_mode="all") # multiple gaussian
